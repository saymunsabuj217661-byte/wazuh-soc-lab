...
Select the appropriate operating system package.
...
```bash
<Generated installation command from Wazuh Dashboard>
```

The installation downloads and installs the Wazuh Agent package automatically.
...
On the Wazuh Server, verify that the agent has been registered successfully.
...
![Registered Agent](../screenshots/phase-09/05-agent-control.png)

---

# Step 6: Verify Agent in Dashboard
...
![Agent Active](../screenshots/phase-09/06-agent-active-dashboard.png)

---

# Step 7: Review Agent Details
...
![Agent Details](../screenshots/phase-09/07-agent-details.png)
...
- Agent service running normally.
- Agent visible in the Wazuh Dashboard.
- Communication between Agent and Manager established successfully.
